...
import { Star, Archive, Trash2, Mail, Clock, FileText } from "lucide-react";
...
const EmailItem = ({
  ...
  return (
    <div
      className={`
        px-6 py-4 hover:bg-gray-50 cursor-pointer transition-colors flex items-center space-x-4 group border-b border-gray-100
    ...
    >
      ...
      <button
        ...
        className="text-gray-300 hover:text-yellow-500 transition-colors group-hover:text-gray-400"
      >
        {isStarred ? (
